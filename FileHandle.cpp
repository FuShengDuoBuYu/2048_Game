...
using namespace std;
vector<string> FileHandle::readFiles(string inputFilename){
...
char FileHandle::handleMessageInFile(vector<string> fileContent,int &ROW,int &COL){
    //第一行的维数
...
vector<string> FileHandle::resultFile(char moveDirections,int ROW,int COL){
...
void FileHandle::outputFile(vector<string> resultString){
